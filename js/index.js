...
(function() {
  var advanceChar, chooseStart, clockRunning, computeWPM, fastestTime, numberOfStartingLetters, reset, start, started, stop, stoppedDuration, timeBegan, timeStopped, typedLetters, typedWrongLetters;
  ...
  $(function() {
    ...
    return $("#q, #w, #e, #r, #t, #y, #u, #i, #o, #p, #a, #s, #d, #f, #g, #h, #j, #k, #l, #z, #x, #c, #v, #b, #n, #m").click(function() {
